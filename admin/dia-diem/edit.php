    ...
    <div class="container-fluid px-4">
      ...
      <div class="card mb-4">
        <div class="card-body">
          ...
          <form action="index.php?act=updateloai" method="post" class="formcontent mt" enctype="multipart/form-data">
            ...
            <div class=" mb10">
              Tên địa điểm
              <br />
              <input type="text"  name="tenloai" value="<?php echo $name_place  ?>"/>
            </div>
            <br />
            <div class=" mb10">
              Địa chỉ
