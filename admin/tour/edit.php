...
<div id="layoutSidenav_content">
  <main>
    ...
    <form action="index.php?act=updatehh" method="post" class="formcontent mt" enctype="multipart/form-data">
      ...
      <br />
      <input class="btn btn-success" value="Cập nhật" type="submit" name="capnhathh"></input>
      <button class="btn btn-warning" type="reset">Nhập lại</button>
      <button class="btn btn-info"><a href="index.php?act=listhh" style="text-decoration: none;">Danh sách tour</a></button>
      <?php
