        ...
        <main>
                        ...
                        <div class="card mb-4">
                                <div class="card-body">
                                        <form action="index.php?act=update_tintuc" method="post" class="formcontent mt"
                                                ...
                                                <input hidden type="text" name="matt"
                                                        value="<?php echo $tt[0]['id_handbook'] ?>">
                                                <br />
          ...
          <?php echo $tt[0]['content'] ?>
                                                ...
                                                <input class="btn btn-success" value="Cập nhật" type="submit"
                                                        name="capnhattt"></input>
                                                <button class="btn btn-warning" type="reset">Nhập lại</button>
                                                <button class="btn btn-info"><a href="index.php?act=list-tintuc"
                                                                style="text-decoration: none;">Danh sách tin
                                                                tức</a></button>
                                                <?php
