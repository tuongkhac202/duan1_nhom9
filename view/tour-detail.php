        ...
        <div class="row m-0 d-flex justify-content-center">
                <div class="row col-10 offset-1  mx-5 px-5 tour-detail">
                        ...
                        <div class="row col-12 mx-0 my-5">
                                <div class="col-12">
                                        <h2 class="font-thu-phap text-danger">
                                                Tour Miền 
                                                <?php echo $tt['category'] ?> - Tour Du Lịch
                                                <?php echo $tt['name_place'] ?>
                                        </h2>
                                </div>
                                ...
                                <div class="row m-0 col-5 form-book">
                                        <form action="index.php?act=booking" method="post" class="bg-light border border-2 rounded-2 border-dark p-3">
                                                ...
                                                <div class="row mx-0 my-1 col-12">
                                                        ...
                                                        <div class="col-11">Số người: <input min="1" max="99" type="number" name="songuoi" class="form-control w-50 d-inline"></div>
                                                </div>
                                                <div class="row mx-0 my-1 col-12">
