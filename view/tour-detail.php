...
<div class="row m-0 d-flex justify-content-center">
        <div class="row col-10 offset-1  mx-5 px-5 tour-detail">
                ...
                <div class="row col-12 mx-0 my-5">
                        <div class="col-12">
                                <h2 class="font-thu-phap text-danger">Tour Miền <?php echo $tt['category'] ?> - Tour Du
                                        Lịch
                        ...
                        <div class="row m-0 col-5 form-book">
                                <form action="index.php?act=bo" method="post"
                                        ...
                                        <div class="row mx-0 my-1 col-12">
                                                ...
                                                <div class="col-11">Ngày khởi hành: <?php echo $tt['day_start']  ?>
                                                </div>
                                        </div>
                                        <div class="row mx-0 my-1 col-12">
                                        ...
                                        <div class="row mx-0 my-1 col-12">
                                                ...
                                                <input type="text" hidden value="<?php echo $tt['id_tour'] ?>"
                                                        name="matour">
                                        </div>
                                        <div class="row mx-0 my-1 col-12">
                                                <div class="col-1"><i class="fas fa-dollar-sign"></i></div>
                                                <div class="col-11 text-danger">Giá tour:
                                                        <?php echo number_format($tt['price'],0,',','.') ?> VNĐ</div>
                                        </div>
                                        <div class="row mx-0 my-1 col-12">
                                                <div class="col-12 text-danger">
                                                        <textarea name="ghichu" id="" cols="30" rows="5"
                                        ...
                                        <div class="row mx-0 my-1 col-12">
                                                <div class="col-12 text-center my-2">
                                                        <input type="submit" class="btn btn-danger" name="book"
                                                                value="ĐẶT TOUR">
                                                </div>
                                        </div>
                                        <?php
                ...
                ?>
                        ...
                        <div class="row m-0 col-7 ">
                                ...
                                <div class="row col-12 p-0 m-0">
                                        <div
                                                class="col-12 p-0 text-center text-white bg-danger rounded-top d-flex align-items-center justify-content-center boxtitle ">
                           ...
                           ';
                                ...
                                ?>
                                        ...
                                        <div class="boxfooter p-0">
                                                <form action="index.php?act=binh-luan-tour&id=<?php echo $id_tour ?>"
                                                        method="post">
                                                        <input type="text" hidden name="idtour"
                                                                value="<?php echo $_GET['id'] ?>">
                                                        <input type="text" placeholder="Nhập nội dung bình luận"
                                                                name="ndbl" class="form-control w-100"
                                                                style="margin-bottom: 5px;">
                                                        <input type="submit" value="Gửi bình luận" name="bl"
                        ...
                        <div class="row m-0 px-0 col-5 bg-light">
                                <div
                                        class="col-12 bg-danger rounded-top text-white d-flex justify-content-center align-items-center">
