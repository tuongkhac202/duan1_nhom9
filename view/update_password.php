<form class="col-6 offset-3  bg-light rounded p-4" action="index.php?act=update_password" method="post">
        ...
        <input class="col form-control m-2" type="password" name="renew_password" placeholder="Nhập lại mật khẩu mới">
        <center>
                <input class="btn btn-warning d-flex justify-content-center mt-2" type="submit" name="update_pass" value="Cập nhật">
        </center>
